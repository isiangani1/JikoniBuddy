...
- [ ] Heatmap of demand > supply
- [ ] Performance by zone (CBD, Westlands, etc.)

---

## Phase 7 — Financial Control Enhancements
- [ ] Revenue breakdown (platform fees / delivery / commissions)
- [ ] Settlement status pipeline (pending → processing → paid)
- [ ] Wallet anomaly detection (unusual withdrawals)
- [ ] Payout success rate + failure reasons

---

## Phase 8 — SLA & Performance Monitoring
- [ ] Track avg delivery time
- [ ] Order success rate
- [ ] Refund rate
- [ ] SLA targets (Delivery < 45 mins, Match < 2 mins)
...
## Phase 11 — Audit Trail (Enterprise)
- [ ] Log every admin action (who/what/when)
- [ ] Searchable audit log
- [ ] Export audit log CSV

---

## Phase 12 — Experimentation / Growth Tools
- [ ] A/B testing framework
- [ ] Experiment: delivery fees
- [ ] Experiment: promo banners
- [ ] Promo targeting (Nairobi CBD, etc.)

---

## Final Structure (Navigation)
- [ ] Live Command Center
- [ ] Orders & Operations
- [ ] Buddy Pool Intelligence
- [ ] Trust & Safety
- [ ] Finance & Payouts
- [ ] Sellers
- [ ] Users
